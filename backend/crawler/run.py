        ...
        for data in startups:
            ...
            if existing:
                ...
                startup = Startup(
                    ...
                    total_revenue=data.get("total_revenue_raw") or None,
                    mrr=data.get("mrr_raw") or None,
                    revenue_30d=data.get("revenue_last_4_weeks_raw") or data.get("revenue_30d") or None,
                    asking_price=data.get("asking_price_raw") or None,
                    is_for_sale=data.get("is_for_sale", False),
                    rank=data.get("rank") or None,
                    customers_count=data.get("active_subscriptions") or data.get("customers_count") or None,
